...
@Component
@Scope("prototype")
public class FullThreadPoolExecutor extends ThreadPoolExecutor {
    private Logger logger = LoggerFactory.getLogger(FullThreadPoolExecutor.class);
    /**
